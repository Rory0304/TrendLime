...
class QuestionSerializer(serializers.ModelSerializer):
  class Meta: 
    ...
    fields = ('category_id', 'category', 'question', 'required') # 필드 설정
