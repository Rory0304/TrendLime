...
class SongAdmin(admin.ModelAdmin):
  list_display = ("song_id", "singer", "song_name", "artist", "album", "Like_Count", "Lyric", "cover_url", "words", "label", "youtube_url", "exciting", "ballad", "grooved", "emotional", "acoustic", "electronic", "sweet", "dreamy", "strong", "windless", "oldies", "sad", "sensual", "sexy", "lonesome", "soulful", "refreshing", "spring", "summer", "autumn", "winter", "morning", "afternoon", "dinner", "night_dawn", "sunny", "rain_cloudy", "snowy", "after_rain_clear", "cool", "chilly", "drive", "exercise_health", "on_the_way_to_school", "on_the_way_home", "relaxation_meditation", "club_party", "cafe", "karaoke", "in_the_reading_room", "walk_trip", "office", "select_shop_store", "hotel_bar", "before_sleeping", "marriage", "festival", "fashion_show", "eat_alone", "when_studying", "love_joy", "farewell_sad", "stress_irritability", "when_depressed", "when_you_are_tired", "mental_anxiety", "longing", "when_youre_lonely", "confession", "when_you_want_to_cry", "dawn", "bubbly", "excitement_heart", "diversion", "healing" )
